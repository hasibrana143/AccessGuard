...
- Name: dashboard.spec.ts >> Sidebar Navigation >> should show AccessGuard logo
- Location: e2e/dashboard.spec.ts:79:7
...
Locator: locator('text=AccessGuard')
Expected: visible
Error: strict mode violation: locator('text=AccessGuard') resolved to 3 elements:
    1) <span class="text-lg font-bold">AccessGuard</span> aka getByText('AccessGuard', { exact: true })
    2) <p class="text-xs text-muted-foreground truncate">demo@accessguard.io</p> aka getByText('demo@accessguard.io')
    3) <span>AccessGuard © 2024</span> aka getByText('AccessGuard ©')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=AccessGuard')
