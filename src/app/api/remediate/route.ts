...
const WCAG_RULES: Record<string, { name: string; requirement: string }> = {
  'color-contrast': {
...
async function generateRemediation(violation: RemediationRequest) {
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Get the violation from the database
    ...
    console.error('Error in remediation API:', error);
    return NextResponse.json(
