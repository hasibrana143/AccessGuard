    ...
    return [
      {
        ...
        headers: [
          ...
          {
            // Enforced (was Report-Only): blocks object/frame injection and
            // off-allowlist scripts. report-uri keeps feeding /api/csp-report
            // so new violations are visible before they become incidents.
