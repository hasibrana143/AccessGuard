...
> **STOP.** Before running the 11-section deep review, required outputs, and review report (only after Step 0 scope and mode are agreed), Read `C:\PROJECTS\AccessGuard\.openclaw\skills/plan-ceo-review/sections/review-sections.md` and execute it
