...
> **STOP.** Before running the 7 design passes, required outputs, and review report (only after Step 0 scope is agreed), Read `C:\PROJECTS\AccessGuard\.openclaw\skills/plan-design-review/sections/review-sections.md` and execute it
